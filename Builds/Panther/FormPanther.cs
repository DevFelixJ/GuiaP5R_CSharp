...
namespace Persona5Royal.Builds.Panther
{
    public partial class FormPanther : Form
    {
        ...
        public FormPanther()
        {
            ...
            this.FormClosing += FormPanther_FormClosing;
        ...
        private void FormPanther_FormClosing(object sender, FormClosingEventArgs e)
        {
            // Verificar si el cierre es una acción del usuario.
